...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicmFqYWtpc2hvcnJlZGR5IiwiYSI6ImNra2t4bXhldjJ0N2ozMG9jejZxN3NrZTYifQ.TdmCnFkCOmlp7uBTEQkvFA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/rajakishorreddy/ckkkygdpe2uxo17ryareaf8cg',
    scrollZoom: false //   center: [-118.24368, 34.05223],
    //   zoom: 4,
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "Logged in successfullly!");
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            window.setTimeout(function () {
              location.assign('/');
            }, 1500); //true makes reload from the server and not from the browser cache(might reload the same page)
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51IHNiJBRuLrQXYb8nOayFHP9Y2ndffCB26rlF4vkeXLQOX584CPgd8phEqYzcjINIdTB9WK5he6HeqQnjuXU8xZR001ioQDdzo');
            _context.next = 4;
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault(); //manually creating multipart/form-data
